...
class StoreZoneClient(AsyncBaseAPIClient):
    """상권 조회 전용 클라이언트"""

    async def get_storeZoneOne(self, store_zone: str) -> dict | None:
    ...
    async def get_storeZoneInRadius(self, radius: int, cx: float, cy: float):
    ...
    async def get_storeZoneInRectangle(
    ...
    async def get_storeZoneInAdmi(self, divID: str, district_code: str):
